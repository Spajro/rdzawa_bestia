use shakmaty::{Board, Chess, Color, File, Position, Rank, Square};
...
pub const KING_SQUARE_TABLE: [i32; 64] = [
    ...
    -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70, -70,
    -70, -70, -60, -60, -60, -60, -60, -60, -60, -60, 3, 1, -5, -15, -15, -5, 1, 3, 5, 20, 10, 0,
    5, 0, 40, 20,
];
...
pub const KNIGHT_SQUARE_TABLE: [i32; 64] = [
    -60, -60, -30, -30, -30, -30, -60, -60, -40, -40, -20, -20, -20, -20, -40, -40, -20, 60, 40,
    60, 60, 100, 50, 20, -5, 10, 10, 40, 20, 20, 10, 10, -10, 5, 10, 10, 20, 10, 20, -8, -15, -10,
    12, 10, 10, 12, -10, -15, -20, -50, -10, 0, 0, -10, -50, -20, -100, -20, -30, -40, -40, -30,
    -20, -100,
];

pub const PAWN_SQUARE_TABLE: [i32; 64] = [
    0, 0, 0, 0, 0, 0, 0, 0, 20, 25, 30, 35, 35, 30, 25, 20, 15, 20, 25, 30, 30, 25, 20, 15, 10, 15,
    20, 25, 25, 20, 15, 10, 5, 10, 15, 30, 30, 15, 10, 5, 3, 5, 10, 15, 15, 10, 5, 3, 0, 0, 0, 0,
...
mod eval_tests {
    ...
    fn board_after_taking_pawn_test() {
        ...
        let chess3 = chess2
            ...
            .unwrap();
        assert_eq!(1.25, eval(&chess3, false))
    }
